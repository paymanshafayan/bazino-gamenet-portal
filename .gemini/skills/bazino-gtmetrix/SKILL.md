---
name: bazino-gtmetrix
description: Fix GTmetrix/PageSpeed performance issues in the Bazino Pro web app: code splitting with React.lazy, WebP/JPG image optimization, font <link> instead of @import, preconnect, lazy loading with fetchpriority on active hero slide, explicit image dimensions, and immutable cache headers. Use when a performance report arrives or bundles/images grow.
metadata:
  author: bazino
  version: "1.0.0"
---
