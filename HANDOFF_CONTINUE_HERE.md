...
هشت بچ کد و تست محلی اجرا شدند؛ **503/503** تست، TypeScript/build، Chromium واقعی چهارزبانه و restart فرایند با حفظ رسانه موفق‌اند. مرجع اصلی [گزارش تحویل](docs/publishing/V4_DELIVERY.md) و [راهنمای هاست/استفاده](docs/publishing/DEPLOY_AND_OPERATE.md) است. این دیگر صرفاً پلن نیست.
...
- ۱۹ تصویر کامل تولید شد؛ بازبینی تصویر، فونت سیریلیک گم‌شده را پیدا کرد؛ اصلاح و اجرای دوباره انجام شد. DOM-only به‌عنوان بازبینی تصویر گزارش نشد.
