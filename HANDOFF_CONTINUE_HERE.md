...
## ★ وضعیت جدیدتر — 2026-09-07: پلن نسخهٔ ۳ و Composer انتشار ادمین

**ابتدا این بخش و `HANDOFF_PROMPT.md §۲۱` خوانده شود.** اصل متن کاربر در `docs/payments/INSTAGRAM_AFFILIATE_DESIGN.md` محفوظ است. پلن `docs/payments/INSTAGRAM_MEDIA_ONLY_PLAN.md` اکنون **نسخهٔ ۳ / ۸ بچ** است؛ رویدادها/معماری و جزئیات Composer در `docs/publishing/ZERNIO_EVENTS_AND_ARCHITECTURE.md §۵٫۱` آمده‌اند. **هنوز اجرای کد/استقرار تأیید یا شروع نشده**.
