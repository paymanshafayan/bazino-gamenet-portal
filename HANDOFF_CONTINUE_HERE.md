...
## ★ وضعیت جدیدتر — 2026-09-07: پلن نسخهٔ ۲، رویدادهای Zernio و ناشر قابل‌تعویض

**ابتدا این بخش و `HANDOFF_PROMPT.md §۲۰` خوانده شود.** اصل متن کاربر در `docs/payments/INSTAGRAM_AFFILIATE_DESIGN.md` محفوظ است. پلن `docs/payments/INSTAGRAM_MEDIA_ONLY_PLAN.md` اکنون **نسخهٔ ۲ / ۸ بچ** است؛ فهرست تیک‌ها و طراحی ناشر قابل‌تعویض در `docs/publishing/ZERNIO_EVENTS_AND_ARCHITECTURE.md` آمده‌اند. **هنوز اجرای کد/استقرار تأیید یا شروع نشده**.
