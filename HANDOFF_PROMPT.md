...
>
> **اجرا شروع شده: پلن نسخهٔ ۴، آخرین بچ ثبت‌شده 1.** کاربر «شروع کن» گفت. مرجع وضعیت و شواهد: `docs/publishing/V4_EXECUTION_LOG.md`. توسعهٔ مستقل تا انتهای هشت بچ ادامه دارد؛ انتشار واقعی با مجوز و اتصال معتبر جدا تأیید می‌شود.
>
