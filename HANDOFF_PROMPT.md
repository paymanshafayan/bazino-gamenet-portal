...
>
> تاریخ تنظیم: ۱۴۰۵/۰۶/۱۰ (2026-09-01) · آخرین به‌روزرسانی: **۱۴۰۵/۰۶/۱۶ (2026-09-07)**، دریافت متن کامل طرح افیلیت، تطبیق Media ID و پلن نهایی در **بخش ۱۹**؛ قوانین تحویل خودکار/صدق اثبات در §۵٫۵ · ریپو: `paymanshafayan/bazino-gamenet-portal`
...
>
> **کار جاری: بخش ۱۹، `docs/payments/INSTAGRAM_AFFILIATE_DESIGN.md` و `docs/payments/INSTAGRAM_MEDIA_ONLY_PLAN.md`.** متن کامل اکنون از پیام کاربر دریافت و ذخیره شده؛ مانع پیوست دیگر باز نیست. پلن نهایی پیشنهادی: Manus فقط ID رسانه، تطبیق دقیق همان ID با Zernio، PR اول/DM دوم، کد فقط برای همکار و لینک فقط برای دوست. **منتظر تأیید اجرا؛ هنوز کد محصول/هاست تغییر نکرده است.** اشتراک Zernio با `/api/webhooks/zernio` طبق اعلام کاربر موجود است؛ موفقیت receiver روی هاست تأیید نشده.
>
> **اول بخش ۱۹ و پلن نهایی را برای کار جاری بخوانید؛ وضعیت عمومی پس از PR #19 در بخش ۱۶ است.** بخش ۱۵، بازبینی تاریخیِ پایهٔ PR #18 است و عبارت‌های «batchهای ۶–۸ کد نشده‌اند» در آن دیگر وضعیت فعلی نیستند. وجود کد/رابط با تکمیل همهٔ معیارهای پذیرش، سبزبودن کل تست‌ها یا تأیید اتصال زنده یکی نیست؛ مرز گزارش و نکات باز در §۱۶٫۳ آمده‌اند. POS سخت‌افزاری و تستر آن متوقف‌اند. مراجع: `docs/management/EXPANSION_PLAN.md`، `docs/management/EXECUTION_LOG.md` و بخش ستاره‌دار بالای `HANDOFF_CONTINUE_HERE.md`.
