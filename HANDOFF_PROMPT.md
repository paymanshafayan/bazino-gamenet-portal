...
>
> تاریخ تنظیم: ۱۴۰۵/۰۶/۱۰ (2026-09-01) · آخرین به‌روزرسانی: **۱۴۰۵/۰۶/۱۶ (2026-09-07)**، انتشار دستی ادمین با بارگذاری رسانه/کپشن/قالب، **پلن نسخهٔ ۳ / بخش ۲۱**؛ انتخاب رویدادها/ناشر در بخش ۲۰ و اصل طرح افیلیت در بخش ۱۹ · ریپو: `paymanshafayan/bazino-gamenet-portal`
...
>
> **کار جاری: بخش ۲۱ و پلن نسخهٔ ۳.** ادمین باید از ContentConsole مشترک، فایل تصویر/ویدئو بارگذاری، caption وارد، قالب تک‌تصویر/Carousel/Reel و Story مجاز انتخاب و با Zernio منتشر کند. media library پایدار، preview/ترتیب اسلایدها/approval و زمان‌بندی نیز جزو بچ ۷ هستند. پلن هنوز ۸ بچ و فهرست اصلی ۲۳ رویداد دارد؛ **فقط طراحی/اسناد به‌روز شده و اجرای کد/استقرار شروع نشده است**.
>
> **اول بخش ۲۱ و پلن نسخهٔ ۳ را برای کار جاری بخوانید؛ معماری ناشر در بخش ۲۰، اصل قواعد افیلیت در بخش ۱۹ و وضعیت عمومی پس از PR #19 در بخش ۱۶ است.** بخش ۱۵، بازبینی تاریخیِ پایهٔ PR #18 است و عبارت‌های «batchهای ۶–۸ کد نشده‌اند» در آن دیگر وضعیت فعلی نیستند. وجود کد/رابط با تکمیل همهٔ معیارهای پذیرش، سبزبودن کل تست‌ها یا تأیید اتصال زنده یکی نیست؛ مرز گزارش و نکات باز در §۱۶٫۳ آمده‌اند. POS سخت‌افزاری و تستر آن متوقف‌اند. مراجع: `docs/management/EXPANSION_PLAN.md`، `docs/management/EXECUTION_LOG.md` و بخش ستاره‌دار بالای `HANDOFF_CONTINUE_HERE.md`.
