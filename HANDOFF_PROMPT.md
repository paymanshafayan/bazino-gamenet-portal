...
* `transactions` و `active_coupons` ستون `username` ندارند، پس تاریخچه‌ی امتیاز و کوپن‌ها
  همچنان سراسری‌اند (هر کاربر تراکنش‌های همه را می‌بیند). رفعش نیاز به مهاجرت اسکیما دارد.
