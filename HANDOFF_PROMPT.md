...
>
> تاریخ تنظیم: ۱۴۰۵/۰۶/۱۰ (2026-09-01) · آخرین به‌روزرسانی: **۱۴۰۵/۰۶/۲۳ (2026-09-14)**، فلو جدید افیلیت اینستاگرام (لینک مستقیم همکار) در **بخش ۳۳**؛ فهرست ۷موردی کارفرما در **بخش ۲۵**؛ صفحهٔ «بازی‌ها» در **بخش ۲۴**؛ گزارش V4 در **بخش ۲۳** و `docs/publishing/V4_DELIVERY.md` · ریپو: `paymanshafayan/bazino-gamenet-portal`
> برنچ نشست جاری: **`arena/01a089a9-bazino-gamenet-portal`** (برنچ دیپلوی Railway — هر پوش = دیپلوی پروداکشن). نشست قبلی: `arena/01a08992-bazino-gamenet-portal`.
