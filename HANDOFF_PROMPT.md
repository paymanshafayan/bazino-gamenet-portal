...
- **✅ رگرسیون §۲۵ + فلو دوست — تست‌شده توسط کارفرما (۲۰۲۶-۰۹-۱۰ شب):** کارفرما خودش از اکانت دوم تست گرفت و تأیید کرد: کامنت کیورد → **دایرکت ارسال شد** و **لینک دعوت (invite link) کار می‌کند** — یعنی فلو کیورد→DM و مسیر لینک خصوصی دعوت (بخشی از پلن فلو دوست بخش دوم، آپدیت ۲۱:۳۵) روی پروداکشن عملیاتی است. **نکتهٔ ثبت صادقانه:** معیار دقیق §۲۵ «فقط ۱ دایرکت» بود؛ کارفرما ارسال را تأیید کرد ولی شمارش دقیق (۱ و نه تکرار) و زنجیرهٔ کامل claim/اتریبیوشن/کوپن صریحاً تأیید نشد — در صورت گزارش بعدی تکمیل شود. بستن بک‌لاگ: رگرسیون §۲۵ ✅ (به روایت کارفرما)، فلو دوست بخش دوم (لینک دعوت) ✅.
