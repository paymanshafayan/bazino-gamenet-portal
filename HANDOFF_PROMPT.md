...
>
> تاریخ تنظیم: ۱۴۰۵/۰۶/۱۰ (2026-09-01) · آخرین به‌روزرسانی: **۱۴۰۵/۰۶/۱۶ (2026-09-07)**، سوییچ دستی/عامل، تعریف عامل با API Key و Manus پیش‌فرض ماندگار، **پلن نسخهٔ ۴ / بخش ۲۲**؛ Composer در بخش ۲۱ و اصل طرح افیلیت در بخش ۱۹ · ریپو: `paymanshafayan/bazino-gamenet-portal`
...
>
> **کار جاری: بخش ۲۲ و پلن نسخهٔ ۴.** پنل سوییچ دستی/عامل و Agent Registry با API Key امن داشته باشد؛ Manus با رکورد واقعی و defaultAgentId در DB seed شود، نه فقط hardcode فرم. mode/default انتخاب‌شده ماندگار و مستقل از jobهای جاری است؛ نبود کلید، آمادگی واقعی نیست. همچنان ۸ بچ و ۲۳ رویداد اصلی؛ **فقط طراحی/اسناد تغییر کرده و اجرا/استقرار شروع نشده است**.
>
> **اول بخش ۲۲ و پلن نسخهٔ ۴ را برای کار جاری بخوانید؛ Composer در بخش ۲۱، معماری ناشر در بخش ۲۰ و اصل قواعد افیلیت در بخش ۱۹ است.** بخش ۱۵، بازبینی تاریخیِ پایهٔ PR #18 است و عبارت‌های «batchهای ۶–۸ کد نشده‌اند» در آن دیگر وضعیت فعلی نیستند. وجود کد/رابط با تکمیل همهٔ معیارهای پذیرش، سبزبودن کل تست‌ها یا تأیید اتصال زنده یکی نیست؛ مرز گزارش و نکات باز در §۱۶٫۳ آمده‌اند. POS سخت‌افزاری و تستر آن متوقف‌اند. مراجع: `docs/management/EXPANSION_PLAN.md`، `docs/management/EXECUTION_LOG.md` و بخش ستاره‌دار بالای `HANDOFF_CONTINUE_HERE.md`.
