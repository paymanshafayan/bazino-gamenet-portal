...
>
> تاریخ تنظیم: ۱۴۰۵/۰۶/۱۰ (2026-09-01) · آخرین به‌روزرسانی: **۱۴۰۵/۰۶/۱۶ (2026-09-07)**، تحویل اجرای هشت بچ V4، 506 تست و شواهد Chromium؛ مرجع جاری `docs/publishing/V4_DELIVERY.md` · ریپو: `paymanshafayan/bazino-gamenet-portal`
...
>
> **اجرای V4: هشت بچ توسعه/تست محلی تکمیل شد.** 506/506 تست، TypeScript و build هر دو پروژه، Chromium واقعی چهارزبانه و restart ماندگاری موفق شدند. مرجع جاری **`docs/publishing/V4_DELIVERY.md`** و راهنمای **`DEPLOY_AND_OPERATE.md`** است. نتیجهٔ GitHub/استقرار و موارد live تست‌نشده را جدا بخوانید؛ عبارات قدیمی «منتظر شروع» تاریخچه‌اند.
>
