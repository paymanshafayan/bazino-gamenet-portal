...
>
> **اجرای V4: هشت بچ توسعه/تست محلی تکمیل شد.** 503/503 تست، TypeScript و build هر دو پروژه، Chromium واقعی چهارزبانه و restart ماندگاری موفق شدند. مرجع جاری **`docs/publishing/V4_DELIVERY.md`** و راهنمای **`DEPLOY_AND_OPERATE.md`** است. نتیجهٔ GitHub/استقرار و موارد live تست‌نشده را جدا بخوانید؛ عبارات قدیمی «منتظر شروع» تاریخچه‌اند.
>
> **اول `docs/publishing/V4_DELIVERY.md` و گزارش Batch 8 انتهای همین سند را بخوانید؛ بخش‌های ۱۹–۲۲ سابقهٔ طراحی‌اند.** بخش ۱۵، بازبینی تاریخیِ پایهٔ PR #18 است و عبارت‌های «batchهای ۶–۸ کد نشده‌اند» در آن دیگر وضعیت فعلی نیستند. وجود کد/رابط با تکمیل همهٔ معیارهای پذیرش، سبزبودن کل تست‌ها یا تأیید اتصال زنده یکی نیست؛ مرز گزارش و نکات باز در §۱۶٫۳ آمده‌اند. POS سخت‌افزاری و تستر آن متوقف‌اند. مراجع: `docs/management/EXPANSION_PLAN.md`، `docs/management/EXECUTION_LOG.md` و بخش ستاره‌دار بالای `HANDOFF_CONTINUE_HERE.md`.
