...
>
> تاریخ تنظیم: ۱۴۰۵/۰۶/۱۰ (2026-09-01) · آخرین به‌روزرسانی: **۱۴۰۵/۰۶/۱۶ (2026-09-07)**، انتخاب رویدادهای وب‌هوک و معماری ناشر قابل‌تعویض، **پلن نسخهٔ ۲ / بخش ۲۰**؛ اصل طرح افیلیت و بررسی نسخهٔ ۱ در بخش ۱۹ · ریپو: `paymanshafayan/bazino-gamenet-portal`
...
>
> **کار جاری: بخش ۲۰ و پلن نسخهٔ ۲.** `docs/publishing/ZERNIO_EVENTS_AND_ARCHITECTURE.md` فهرست ۲۳ رویداد وب‌هوک اصلی و طرح جداسازی ناشر است؛ `INSTAGRAM_MEDIA_ONLY_PLAN.md` اکنون ۸ بچ دارد. امروز Manus فقط ID رسانه می‌فرستد؛ در آینده پنل از Zernio منتشر می‌کند و هر دو به registry مصوب مشترک می‌رسند. Analytics در اشتراک/صف جدا. **هنوز تأیید اجرای کد/استقرار صادر نشده و فقط اسناد تغییر کرده‌اند.**
>
> **اول بخش ۲۰ و پلن نسخهٔ ۲ را برای کار جاری بخوانید؛ اصل قواعد افیلیت در بخش ۱۹ و وضعیت عمومی پس از PR #19 در بخش ۱۶ است.** بخش ۱۵، بازبینی تاریخیِ پایهٔ PR #18 است و عبارت‌های «batchهای ۶–۸ کد نشده‌اند» در آن دیگر وضعیت فعلی نیستند. وجود کد/رابط با تکمیل همهٔ معیارهای پذیرش، سبزبودن کل تست‌ها یا تأیید اتصال زنده یکی نیست؛ مرز گزارش و نکات باز در §۱۶٫۳ آمده‌اند. POS سخت‌افزاری و تستر آن متوقف‌اند. مراجع: `docs/management/EXPANSION_PLAN.md`، `docs/management/EXECUTION_LOG.md` و بخش ستاره‌دار بالای `HANDOFF_CONTINUE_HERE.md`.
