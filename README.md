...
| 🪙 کردیت بازینو (BC) | پرداخت رزرو با کردیت به نرخ تخت زمانی + قیمت کردیتی محصولات کاتالوگ؛ شارژ دستی از پنل ادمین تا نهایی‌شدن روش‌های کسب |
| 📱 ورود با پیامک + پروفایل + تیکت | ورود OTP، پروفایل `/profile` (کیف پول، امتیاز، رزرو، سفارش، تورنمنت، پشتیبانی، امنیت) |
| 💬 چت زنده | اتاق‌های گفتگو با WebSocket — فعلاً **غیرفعال** (از منو حذف شده؛ بازگردانی با پرچم `chat_enabled` در سفارشی‌سازی) |
