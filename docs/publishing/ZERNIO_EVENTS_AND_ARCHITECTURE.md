...
وضعیت جاری: **پیاده‌سازی و تست محلی V4 انجام شده؛ [گزارش تحویل](V4_DELIVERY.md) و [راهنمای اجرا](DEPLOY_AND_OPERATE.md) ملاک‌اند.** متن زیر قرارداد طراحی است؛ استقرار/تماس live جدا تأیید می‌شود.
