...
class HomeScreen extends StatelessWidget {
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: GamingTheme.primary.withOpacity(0.2), width: 1.5),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 13, height: 1.6, color: Colors.white.withOpacity(0.8)),
                ),
                      ...
                      Column(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: GamingTheme.accentRed.withOpacity(0.2),
  ...
  Widget _buildTeamBadge(String name, bool isFirst) {
    return Column(
      children: [
        CircleAvatar(
          backgroundColor: isFirst ? GamingTheme.primary.withOpacity(0.1) : GamingTheme.accentRed.withOpacity(0.1),
          radius: 20,
          child: Icon(
