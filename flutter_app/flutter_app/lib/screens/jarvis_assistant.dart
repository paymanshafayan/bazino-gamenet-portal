      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: _getThemeColor(widget.state).withOpacity(0.15),
                blurRadius: 30,
                spreadRadius: 2,
              )
            ],
  ...
  void _drawCharacterFace(Canvas canvas, Offset center, double radius, double rotation, Paint glow, Paint solid) {
    ...
    switch (character) {
      case JarvisCharacter.cyberRobot:
        ...
        canvas.drawCircle(center, 8.0, Paint()..color = _getStateColor().withOpacity(0.3)..style = PaintingStyle.fill);
      ...
      case JarvisCharacter.mechGamer:
        ...
        canvas.drawPath(trianglePath, Paint()..color = _getStateColor().withOpacity(0.05)..style = PaintingStyle.fill);
        ...
        for (int i = 0; i < 3; i++) {
          ...
          canvas.drawCircle(pointerTip, 3.0, Paint()..color = _getStateColor().withOpacity(0.8)..style = PaintingStyle.fill);
        }
        break;
    }
  }
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              height: 4,
              decoration: BoxDecoration(
                color: GamingTheme.primary.withOpacity(0.4),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: msg.isUser
                              ? GamingTheme.secondary.withOpacity(0.25)
                          ...
                          border: Border.all(
                            color: msg.isUser
                                ? GamingTheme.secondary.withOpacity(0.4)
                  ...
                  return Container(
                    ...
                    child: ActionChip(
                      ...
                      shape: RoundedRectangleBorder(
                        ...
                        side: BorderSide(color: GamingTheme.primary.withOpacity(0.15)),
                      ),
                      onPressed: () {
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: (jarvisState.isListening ? GamingTheme.secondary : GamingTheme.primary).withOpacity(0.4),
