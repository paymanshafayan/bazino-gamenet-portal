...
class GamingTheme {
  ...
  static BoxDecoration glassDecoration({
    ...
    return BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(color: glow.withValues(alpha: glowOpacity * 0.35), blurRadius: 24, spreadRadius: -4),
      ],
    );
  }
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: primary.withValues(alpha: 0.16), width: 1),
        ),
      ),
      textTheme: TextTheme(
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: GamingTheme.secondary.withValues(alpha: 0.4), blurRadius: 20, spreadRadius: -4, offset: const Offset(0, 8)),
        ],
      ),
      child: Material(
...
class HexagonBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        boxShadow: [
          BoxShadow(color: GamingTheme.primary.withValues(alpha: glowOpacity * 0.4), blurRadius: size * 0.5, spreadRadius: -2),
        ],
      ),
      child: CustomPaint(
...
class _HexagonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(path, fillPaint..style = PaintingStyle.fill..color = Colors.white.withValues(alpha: 0.06));
