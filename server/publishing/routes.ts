...
export function registerPublishing(app:express.Express,core:OpsCore) {
  ...
  const publishing=new PublishingService(core),mediagen=new MediaGenService(core,undefined,publishing.assets,publishing);
  registerPublicationRoutes(app,publishing,mediagen);
