...
export const SAMPLE_SLIDERS: SliderRow[] = [
  { id: 'slide-1', imageUrl: '/images/home/esports-480.webp', mobileImageUrl: '/images/home/esports-320.webp', target: 'reserve', titleFa: 'رزرو سیستم‌های گیمینگ فوق پیشرفته', titleEn: 'Reserve High-End Gaming Rigs', titleRu: 'Забронировать мощные игровые ПК', titleTr: 'Son Teknoloji Oyun Bilgisayarlarını Rezerve Edin' },
  { id: 'slide-2', imageUrl: '/images/home/cafe-480.webp', mobileImageUrl: '/images/home/cafe-320.webp', target: 'cafe', titleFa: 'سفارش آنلاین انواع پیتزا و نوشیدنی انرژی‌زا', titleEn: 'Order Pizza & Energy Drinks Online', titleRu: 'Заказать пиццу и энергетики онлайн', titleTr: 'Online Pizza ve Enerji İçeceği Sipariş Et' },
  { id: 'slide-3', imageUrl: '/images/home/gear-shop-480.webp', mobileImageUrl: '/images/home/gear-shop-320.webp', target: 'shop', titleFa: 'تجهیزات اورجینال گیمینگ با گارانتی کلوپ', titleEn: 'Original Gaming Gear with Club Warranty', titleRu: 'Оригинальные игровые девайсы с гарантией', titleTr: 'Kulüp Garantili Orijinal Oyun Ekipmanları' },
  { id: 'slide-4', imageUrl: '/images/home/rpg-openworld-480.webp', mobileImageUrl: '/images/home/rpg-openworld-320.webp', target: 'tournaments', titleFa: 'ثبت‌نام در مسابقات با جوایز نقدی بزرگ', titleEn: 'Join Tournaments with Big Cash Prizes', titleRu: 'Участвуйте в турнирах с крупными призами', titleTr: 'Büyük Nakit Ödüllü Turnuvalara Katılın' }
];
