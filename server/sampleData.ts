...
export const SAMPLE_SYSTEMS: SystemRow[] = [
  { id: 's1', name: 'سیستم شماره ۱ (VIP PC)', nameFa: 'سیستم شماره ۱ (VIP PC)', nameEn: 'System #1 (VIP PC)', nameRu: 'Система №1 (VIP PC)', nameTr: 'Sistem No.1 (VIP PC)', type: 'PC', hourlyRate: 35000, isActive: true, isReserved: false },
  { id: 's2', name: 'سیستم شماره ۲ (VIP PC)', nameFa: 'سیستم شماره ۲ (VIP PC)', nameEn: 'System #2 (VIP PC)', nameRu: 'Система №2 (VIP PC)', nameTr: 'Sistem No.2 (VIP PC)', type: 'PC', hourlyRate: 35000, isActive: true, isReserved: true },
  { id: 's3', name: 'سیستم شماره ۳ (Standard)', nameFa: 'سیستم شماره ۳ (Standard)', nameEn: 'System #3 (Standard)', nameRu: 'Система №3 (Standard)', nameTr: 'Sistem No.3 (Standard)', type: 'PC', hourlyRate: 25000, isActive: true, isReserved: false },
  { id: 's4', name: 'سیستم شماره ۴ (Standard)', nameFa: 'سیستم شماره ۴ (Standard)', nameEn: 'System #4 (Standard)', nameRu: 'Система №4 (Standard)', nameTr: 'Sistem No.4 (Standard)', type: 'PC', hourlyRate: 25000, isActive: true, isReserved: false },
  { id: 's5', name: 'کنسول پلی‌استیشن ۵ (VIP Booth)', nameFa: 'کنسول پلی‌استیشن ۵ (VIP Booth)', nameEn: 'PlayStation 5 Console (VIP Booth)', nameRu: 'Консоль PlayStation 5 (VIP-кабина)', nameTr: 'PlayStation 5 Konsolu (VIP Kabin)', type: 'PS5', hourlyRate: 40000, isActive: true, isReserved: true }
];

/* ---------- منوی کافه و بوفه (۵ مورد) ---------- */
export const SAMPLE_CAFE_ITEMS: CafeItemRow[] = [
  { id: 'c1', name: 'پیتزا پپرونی مخصوص گیمرها', nameFa: 'پیتزا پپرونی مخصوص گیمرها', nameEn: 'Gamer Pepperoni Pizza', nameRu: 'Пицца пепперони для геймеров', nameTr: 'Oyuncu Pepperoni Pizzası', category: 'Foods', price: 95000, imageUrl: '/images/home/pizza-400.webp', mobileImageUrl: '/images/mobile/item-pizza.webp', inventory: 15, isAvailable: true },
  { id: 'c2', name: 'همبرگر دوبل با پنیر گودا', nameFa: 'همبرگر دوبل با پنیر گودا', nameEn: 'Double Gouda Cheeseburger', nameRu: 'Двойной бургер с гаудой', nameTr: 'Çift Gouda Peynirli Burger', category: 'Foods', price: 85000, imageUrl: '/images/home/burger-400.webp', mobileImageUrl: '/images/mobile/item-burger.webp', inventory: 10, isAvailable: true },
  { id: 'c3', name: 'نوشابه ردبول خنک (RedBull)', nameFa: 'نوشابه ردبول خنک', nameEn: 'Cold Red Bull Energy Drink', nameRu: 'Холодный энергетик Red Bull', nameTr: 'Soğuk Red Bull Enerji İçeceği', category: 'Drinks', price: 45000, imageUrl: '/images/home/energy-drink-400.webp', mobileImageUrl: '/images/mobile/item-energy-drink.webp', inventory: 32, isAvailable: true },
  { id: 'c4', name: 'سیب‌زمینی سرخ‌کرده با پنیر چدار', nameFa: 'سیب‌زمینی سرخ‌کرده با پنیر چدار', nameEn: 'Cheddar Loaded Fries', nameRu: 'Картофель фри с чеддером', nameTr: 'Çedarlı Patates Kızartması', category: 'Snacks', price: 55000, imageUrl: '/images/home/fries-400.webp', mobileImageUrl: '/images/mobile/item-fries.webp', inventory: 20, isAvailable: true },
  { id: 'c5', name: 'قهوه اسپرسو دبل شات', nameFa: 'قهوه اسپرسو دبل شات', nameEn: 'Double Shot Espresso', nameRu: 'Двойной эспрессо', nameTr: 'Double Shot Espresso', category: 'Drinks', price: 35000, imageUrl: '/images/home/espresso-400.webp', mobileImageUrl: '/images/mobile/item-espresso.webp', inventory: 25, isAvailable: true }
];

/* ---------- فروشگاه تجهیزات جانبی (۵ مورد) ---------- */
export const SAMPLE_ACCESSORIES: AccessoryRow[] = [
  { id: 'a1', name: 'کیبورد مکانیکال Redragon K552 RGB', nameFa: 'کیبورد مکانیکال Redragon K552 RGB', nameEn: 'Redragon K552 RGB Mechanical Keyboard', nameRu: 'Механическая клавиатура Redragon K552 RGB', nameTr: 'Redragon K552 RGB Mekanik Klavye', description: 'کیبورد مکانیکال گیمینگ با سوییچ‌های آبی مقاوم، نورپردازی RGB.', descriptionFa: 'کیبورد مکانیکال گیمینگ با سوییچ‌های آبی مقاوم و نورپردازی RGB.', descriptionEn: 'Gaming mechanical keyboard with durable blue switches and RGB lighting.', descriptionRu: 'Игровая механическая клавиатура с синими свитчами и RGB подсветкой.', descriptionTr: 'Dayanıklı blue switch ve RGB aydınlatmalı mekanik oyuncu klavyesi.', price: 1450000, imageUrl: '/images/home/keyboard-400.webp', mobileImageUrl: '/images/mobile/item-keyboard.webp', stock: 5, category: 'Keyboard' },
  { id: 'a2', name: 'موس گیمینگ Logitech G502 HERO', nameFa: 'موس گیمینگ Logitech G502 HERO', nameEn: 'Logitech G502 HERO Gaming Mouse', nameRu: 'Игровая мышь Logitech G502 HERO', nameTr: 'Logitech G502 HERO Oyuncu Mouse', description: 'موس حرفه‌ای با حسگر HERO 25K، یازده کلید قابل برنامه‌ریزی.', descriptionFa: 'موس حرفه‌ای با حسگر HERO 25K و یازده کلید قابل برنامه‌ریزی.', descriptionEn: 'Pro gaming mouse with HERO 25K sensor and 11 programmable buttons.', descriptionRu: 'Профессиональная мышь с сенсором HERO 25K и 11 кнопками.', descriptionTr: 'HERO 25K sensörlü, 11 programlanabilir tuşlu profesyonel mouse.', price: 1200000, imageUrl: '/images/home/mouse-400.webp', mobileImageUrl: '/images/mobile/item-mouse.webp', stock: 8, category: 'Mouse' },
