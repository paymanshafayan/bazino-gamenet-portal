...
export const SAMPLE_TOURNAMENTS: TournamentRow[] = [
  { id: 't1', title: 'مسابقات قهرمانی Counter-Strike 2 سالن', titleFa: 'مسابقات قهرمانی Counter-Strike 2 سالن', titleEn: 'Counter-Strike 2 Club Championship', titleRu: 'Чемпионат клуба по Counter-Strike 2', titleTr: 'Counter-Strike 2 Kulüp Şampiyonası', game: 'CS2 5v5', registrationFee: 500, startDate: '۱۴۰۵/۰۷/۱۵', maxTeams: 8, status: 'Active', registeredTeamsCount: 2, teams: '[{"name":"Zero Ping","leader":"ali_gamer","members":["reza","sina"]},{"name":"Cyber Storm","leader":"neda","members":["aria","sara"]}]', bracket: '{}' },
  { id: 't2', title: 'لیگ هفتگی دوتا ۲ (Dota 2 Arena)', titleFa: 'لیگ هفتگی دوتا ۲', titleEn: 'Weekly Dota 2 Arena League', titleRu: 'Еженедельная лига Dota 2 Arena', titleTr: 'Haftalık Dota 2 Arena Ligi', game: 'Dota 2 5v5', registrationFee: 600, startDate: '۱۴۰۵/۰۷/۲۵', maxTeams: 8, status: 'Upcoming', registeredTeamsCount: 3, teams: '[{"name":"VIP Gladiators","leader":"amir","members":[]},{"name":"Persian Hawks","leader":"hossein","members":[]},{"name":"Night Owls","leader":"maryam","members":[]}]', bracket: '{}' },
  { id: 't3', title: 'جام باشگاه‌های فیفا ۲۶', titleFa: 'جام باشگاه‌های فیفا ۲۶', titleEn: 'FIFA 26 Clubs Cup', titleRu: 'Кубок клубов FIFA 26', titleTr: 'FIFA 26 Kulüpler Kupası', game: 'FIFA 26 1v1', registrationFee: 300, startDate: '۱۴۰۵/۰۸/۰۵', maxTeams: 16, status: 'Upcoming', registeredTeamsCount: 5, teams: '[{"name":"Barca King","leader":"ehsan","members":[]},{"name":"Real Fan","leader":"kiarash","members":[]}]', bracket: '{}' },
  { id: 't4', title: 'تورنمنت شبانه والورانت (Midnight Clash)', titleFa: 'تورنمنت شبانه والورانت', titleEn: 'Valorant Midnight Clash', titleRu: 'Ночной турнир Valorant', titleTr: 'Valorant Gece Turnuvası', game: 'Valorant 5v5', registrationFee: 400, startDate: '۱۴۰۵/۰۸/۱۵', maxTeams: 8, status: 'Completed', registeredTeamsCount: 8, teams: '[{"name":"Phoenix","leader":"sara","members":[]},{"name":"Radiant","leader":"danial","members":[]}]', bracket: '{}' }
];
...
export const SAMPLE_RESERVATION_LOGS: ReservationLogRow[] = [
  { id: 'r1', systemId: 's2', username: '', systemName: 'سیستم شماره ۲ (VIP PC)', startTime: '14:00', endTime: '16:00', totalPrice: 300, date: 'امروز', checkedIn: false, timestamp: new Date(Date.now() - 7200000).toISOString(), extraControllers: 0 },
  { id: 'r2', systemId: 's5', username: '', systemName: 'کنسول پلی‌استیشن ۵ (VIP Booth)', startTime: '18:00', endTime: '20:00', totalPrice: 400, date: 'امروز', checkedIn: true, timestamp: new Date(Date.now() - 14400000).toISOString(), extraControllers: 0 },
  { id: 'r3', systemId: 's3', username: '', systemName: 'سیستم شماره ۳ (Standard)', startTime: '20:00', endTime: '22:30', totalPrice: 250, date: 'دیروز', checkedIn: true, timestamp: new Date(Date.now() - 90000000).toISOString(), extraControllers: 0 }
];
...
export const SAMPLE_SETTINGS: SettingRow[] = [
  ...
  // پرچم‌های قابلیت (درخواست کارفرما) — از «سفارشی‌سازی کلوپ» قابل تغییر
  { key: 'chat_enabled', value: 'false' },
  { key: 'food_coming_soon', value: 'true' },
  { key: 'shop_coming_soon', value: 'true' },
  // قیمت‌گذاری: دستهٔ اضافهٔ کنسول + کردیت بازینو (BC)
  { key: 'extra_controller_hourly', value: '25' },
  { key: 'gaming_credits_per_hour', value: '100' },
  { key: 'extra_controller_credits_per_hour', value: '20' },
  {
