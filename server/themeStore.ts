...
export const KNOWN_REGIONS = [
  ...
  // Classic inner pages (SDK v2 extended)
  "games", "games.detail",
  "cafe", "cafe.detail", "cafe.cart",
  "shop", "shop.detail", "shop.cart",
  "tournaments", "tournaments.weekly", "tournaments.special", "tournaments.season",
  "tournaments.brackets", "tournaments.register",
  "loyalty",
  "blog", "blog.detail",
  "contact",
  // Hub
