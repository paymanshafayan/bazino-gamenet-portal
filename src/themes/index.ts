 ...
 *       • «نصب از فایل ZIP (فرمت واحد)» → پکیج شامل theme.json + theme.css +
 *         theme.js (هر سه اجباری) که CSS آن دقیقاً همان فرمت فایل‌های
 *         src/themes/*.css است و به‌صورت مستقیم (verbatim) روی سایت اعمال
 *         می‌شود و theme.js صفحه اصلی قالب را با SDK می‌سازد.
